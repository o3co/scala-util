 ...
 *
 */
trait IDProviderActorSelectionAdapterLike[ID] extends IDProviderAdapterLike[ID] {
...
trait IDProviderActorSelectionAdapter[ID] extends IDProviderActorSelectionAdapterLike[ID] 
